...
public class INFYPriceItemProcessor implements ItemProcessor<SecurityPriceInputDTO, SecurityPriceDTO> {

	  private static final Logger log = LoggerFactory.getLogger(INFYPriceItemProcessor.class);
